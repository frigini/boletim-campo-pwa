...
class LocalDatabaseService {
  ...
  private async insertSampleData(): Promise<void> {
    ...
    const sampleBoletim: BoletimCampo = {
      ...
      descricaoServicos: 'Andaime instalado conforme procedimento de segurança. Todas as verificações foram realizadas e aprovadas pela equipe técnica.',
      montagemData: '2024-10-23',
      montagemHoraInicial: '08:00',
      montagemHoraFinal: '12:00',
      montagemSolicitante: 'João Silva Santos',
      montagemMatricula: 'MAT-54321',
      desmontagemData: '2024-10-25',
      desmontagemHoraInicial: '14:00',
      desmontagemHoraFinal: '17:00',
      desmontagemSolicitante: 'Maria Santos Costa',
      desmontagemMatricula: 'MAT-12345',
      escoramento: true,
      escada: false,
